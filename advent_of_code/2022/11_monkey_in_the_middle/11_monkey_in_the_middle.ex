defmodule MonkeyInTheMiddle do
  ...
  def simulate(rounds, func, monkeys) do
    simulate(0, rounds, func, monkeys, %{})
  end

  def simulate(rounds, rounds, _func, _, inspects) do
    monkey_business(inspects)
  end

  def simulate(round, rounds, func, monkeys, inspects) do
    {monkeys, inspects} =
    ...
    simulate(round + 1, rounds, func, monkeys, inspects)
  end
...
common_module =
  monkeys
  |> Map.to_list()
  |> Enum.reduce(1, fn {_i, [_items, _op, test, _if_true, _if_false]}, acc -> acc * test end)

part_2 = MonkeyInTheMiddle.simulate(10000, fn x -> Integer.mod(x, common_module) end, monkeys)
